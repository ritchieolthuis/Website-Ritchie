...
# I will find the portfolio grid container and replace it completely.
# It starts at <div class="relative pl-8 md:pl-12 border-l-2 border-zinc-800 ml-4 max-w-5xl mx-auto space-y-16">
# and ends before <!-- Semester Pages Container -->

def create_roadmap_card(id_str, img_src, year_title, main_title, subtitle):
                  ...
                  <div class="relative group cursor-pointer data-hover-trigger" onclick="window.showSemesterPage('{id_str}')">
                     ...
                     <div class="bg-zinc-900/40 border border-zinc-800 rounded-3xl overflow-hidden hover:border-zinc-700 transition-all duration-500 flex flex-col md:flex-row shadow-lg hover:shadow-2xl">
                         ...
                         <div class="p-8 md:p-12 flex-grow flex flex-col justify-center relative bg-[#121212]">
                            ...
                            <p class="text-zinc-500 text-sm font-mono uppercase tracking-wider">{subtitle}</p>
                         </div>
                     </div>
                  </div>"""

new_grid = f"""<div class="relative pl-8 md:pl-12 border-l-2 border-zinc-800 ml-4 max-w-5xl mx-auto space-y-16" id="portfolio-grid">
...
{create_roadmap_card('jaar2', 'https://stapintechniek.nl/wp-content/uploads/2025/10/7r31189-scaled.jpg', 'Jaar 2', 'Unica Building Services', 'Business Development, Smart Building Positionering & Verduurzaming')}
{create_roadmap_card('jaar3', 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?q=80&w=2070', 'Jaar 3', 'Universiteit Twente & Windesheim', 'Minor Financiële Besluitvorming en Pre master Business Administration')}
{create_roadmap_card('jaar4', 'https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2070', 'Jaar 4', 'Young Professional Commerce Programme', 'Strategische Positionering & Commerciële Optimalisatie')}
{create_roadmap_card('jaar4', 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2070', 'Jaar 4', 'Perron038 Factory NEXT', 'Positionering, Leadgeneratie & Innovatiehub')}
{create_roadmap_card('jaar4', 'https://www.h2owaternetwerk.nl/images/2020/December/vitens_strategie_duurzaam.jpg', 'Jaar 4', 'Vitens Water as a Service', 'Strategische Marktpositionering')}
{create_roadmap_card('afstuderen', 'https://axelio-prod.s3.nl-ams.scw.cloud/Axelio_corporate_foto_a9f672c561.jpg', 'Jaar 4', 'Axelio Afstudeerstage', 'Agrio Entry Strategy UK Markt')}
               </div>"""

# Replace the old roadmap container
start_str = '<div class="relative pl-8 md:pl-12 border-l-2 border-zinc-800 ml-4 max-w-5xl mx-auto space-y-16"'
